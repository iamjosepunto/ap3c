  ...
  return (
    <div className="relative min-h-dvh overflow-hidden">
      ...
      <div className="absolute left-0 top-0 z-10 flex items-start gap-0 sm:gap-1">
        ...
        <p className="parpadeo max-w-[9.5rem] rounded-md border border-line bg-surface/60 px-2.5 py-1.5 text-lg leading-snug text-accent sm:w-[680px] sm:max-w-none sm:px-4 sm:py-3 sm:text-4xl">
          {t('hero.tagline')}
        </p>
      </div>
